...
p <- (p_cftr / p_cftr2) + plot_layout(guides = "collect") +
  ...
  theme(plot.tag = element_text(size = 8, face = "bold"), plot.tag.position = "topleft", legend.position = "top")
...
cairo_pdf(filename = "../Plots/FigureS8.pdf", family = "Arial", width = 7, height = 9) 
p
dev.off()
